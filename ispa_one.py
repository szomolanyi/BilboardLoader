...
DATA_DIR= 'C:/work/web/BIlboards-data/ooh/OOH soft/Data'
# datovy csv subor
DATA_FILE = 'C:/work/web/BIlboards-data/ooh/OOH soft/Data/ispa_1250.csv'
            ...
            if len(row) > 8:
                try:
                    ...
                    files = {
                        ...
                        'street':(None,  row[4].decode('cp1250').encode('utf-8')),
                        'description':(None,  row[50].decode('cp1250').encode('utf-8')),
                        'lat':(None, row[53]),
                        'lng':(None, row[54]),
                    }
                    #files = dict()
